...
# sys.path.insert(0, path.join(_root_directory, "src"))


# -- Helper functions -----------------------------------------------------

def get_dirtyfields_version():
    """
    This helper gets the __version__ string from __init__.py by parsing the AST.
...
release = get_dirtyfields_version()
